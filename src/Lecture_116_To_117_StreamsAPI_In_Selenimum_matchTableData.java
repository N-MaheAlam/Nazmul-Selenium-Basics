...
public class Lecture_116_To_117_StreamsAPI_In_Selenimum_matchTableData {
	...
	public static void main(String[] args) {
		...
		// collect the texts
		// and collect these into a new list which is "orginalList"
		...
		System.out.println("========Lecture 117===============");
		...
		// storing in "price"
		List<String> price = list.stream().filter(s -> s.getText().contains("Beans")).map(p -> getPrice(p))
	...
	public static String getPrice(WebElement l) {
		...
		// 33,(list -variable)
		String price = l.findElement(By.xpath("following-sibling::td[1]")).getText().trim();
		return price;
	}
